...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcApp_interceptorsErrorInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_interceptorsJwtInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcApp_servicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthenticationService = /*#__PURE__*/function () {
      ...
      _createClass(AuthenticationService, [{
        ...
        key: "login",
        value: function login(email, password, nickname) {
          var _this2 = this;

          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiURL, "/authenticate"), {
            email: email,
            password: password,
            nickname: nickname
            ...
            if (user && user.token) {
              ...
              _this2.currentUserSubject.next(user.user);
            }
  ...
  /***/
  function srcApp_servicesScoreServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ScoreService = /*#__PURE__*/function () {
      ...
      _createClass(ScoreService, [{
        ...
        key: "saveScore",
        value: function saveScore(param) {
        ...
        value: function getPDF() {
          return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiURL + '/exporttopdf', {
            responseType: 'blob'
          });
        }
      }, {
        ...
        value: function getExcel() {
          return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiURL + '/exporttoexcel', {
            responseType: 'blob'
          });
        }
      }]);
    ...
    ScoreService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    ScoreService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], ScoreService);
    /***/
  },
    ...
    var UserService = /*#__PURE__*/function () {
      ...
      _createClass(UserService, [{
        ...
        value: function getAll() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiURL, "/get_game"));
        }
      }, {
        key: "getById",
  ...
  function srcAppAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ../_services/score.service */
    "./src/app/_services/score.service.ts");

    var AdminComponent = /*#__PURE__*/function () {
      function AdminComponent(scoreService) {
      ...
      _createClass(AdminComponent, [{
        ...
        key: "getPDFFile",
        value: function getPDFFile() {
          this.scoreService.getPDF().subscribe(function (x) {
            ...
            link.href = data;
            link.download = "score_list.pdf"; // this is necessary as link.click() does not work on the latest firefox
        ...
        key: "getExcelFile",
        value: function getExcelFile() {
          this.scoreService.getExcel().subscribe(function (x) {
            // It is necessary to create a new blob object with mime-type explicitly set
            // otherwise only Chrome works like it should
            var newBlob = new Blob([x], {
            ...
            var link = document.createElement('a');
            link.href = data;
            link.download = "score_list.xlsx"; // this is necessary as link.click() does not work on the latest firefox
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./_models/role */
    "./src/app/_models/role.ts"); // CLI imports router
    ...
    var routes = [{
      ...
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]],
      data: {
        roles: [_models_role__WEBPACK_IMPORTED_MODULE_7__["Role"].Admin]
      }
    }, {
      path: 'login',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_app_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var _interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    "./src/app/_interceptors/error.interceptor.ts"); // CLI imports AppRoutingModule
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"], _admin_admin_component__WEBPACK_IMPORTED_MODULE_6__["AdminComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _app_app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"]],
      providers: [{
        provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HTTP_INTERCEPTORS"],
        useClass: _interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_10__["JwtInterceptor"],
        multi: true
      }, {
        provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HTTP_INTERCEPTORS"],
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_score_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../_services/score.service */
    "./src/app/_services/score.service.ts");
    /* harmony import */
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(userService, scoreService, authenticationService, el) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.scoreService.getRandomGame().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (res) {
            _this5.gameId = res.result._id;
            _this5.gameName = res.result.name;
            _this5.round = res.result.round_of_play;
            _this5.gameloading = false;
        ...
        value: function rollDice() {
          ...
          if (this.played < this.round) {
            ...
            var dice = [this.el.nativeElement.querySelectorAll('.die-list')];
            dice.forEach(function (die) {
              _this6.toggleClasses(die);

              _this6.el.nativeElement.querySelector('.die-list').dataset.roll = random;
            });
            setTimeout(function () {
              _this6.played++;
              _this6.isProsess = false;
              _this6.score = _this6.score + random;

              if (_this6.played == _this6.round) {
                _this6.scoreService.saveScore({
                  "game_id": _this6.gameId,
                  "user_id": _this6.currentUser.id,
                  "score": _this6.score,
                  "time_taken": _this6.transform(_this6.timeTaken)
        ...
        key: "toggleClasses",
        value: function toggleClasses(die) {
          ...
          this.el.nativeElement.querySelector('.die-list').classList.toggle('even-roll'); // die.classList.toggle("odd-roll");
        ...
        value: function oberserableTimer() {
          ...
          var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(1000, 2000);
          var abc = source.subscribe(function (val) {
            _this7.subscribeTimer = _this7.timeTaken - val;
          });
        }
      }, {
        key: "startTimer",
    ...
    var LoginComponent = /*#__PURE__*/function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.loading = true;
          this.authenticationService.login(this.f.username.value, this.f.password.value, this.f.nickname.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).subscribe(function (data) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Projects\myapp\my-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
